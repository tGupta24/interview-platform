...
var stripID3 = (data)=>{
    const bytes = typeof data === "string" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["convertBase64ToUint8Array"])(data) : data;
        ...
        return new Promise((resolve, reject)=>{
            ...
            const establishConnection = async ()=>{
                ...
                try {
                    ...
                    const stream = response.body.pipeThrough(new TextDecoderStream()).pipeThrough((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createEventSourceParserStream"])());
                    const reader = stream.getReader();
   ...
   */ async tools({ schemas = "automatic" } = {}) {
        ...
        try {
            ...
            for (const { name: name17, description, inputSchema } of listToolsResult.tools){
                ...
                const parameters = schemas === "automatic" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$ui$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["jsonSchema"])({
                    ...inputSchema,
