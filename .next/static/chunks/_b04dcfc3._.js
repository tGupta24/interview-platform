...
function AllInterviewsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AllInterviewsPage.useEffect": ()=>{
            const fetchInterviews = {
                "AllInterviewsPage.useEffect.fetchInterviews": async ()=>{
                    ...
                    const data = snapshot.docs.map({
                        "AllInterviewsPage.useEffect.fetchInterviews.data": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["AllInterviewsPage.useEffect.fetchInterviews.data"]);
                    // Sort by createdAt descending (latest first)
                    const sorted = data.sort({
                        "AllInterviewsPage.useEffect.fetchInterviews.sorted": (a, b)=>new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()
                    }["AllInterviewsPage.useEffect.fetchInterviews.sorted"]);
                    setInterviews(sorted);
                }
            }["AllInterviewsPage.useEffect.fetchInterviews"];
            fetchInterviews();
        }
    }["AllInterviewsPage.useEffect"], []);
    const filtered = interviews.filter((interview)=>{
        const matchesType = filter.type ? interview.type === filter.type : true;
        const matchesRole = filter.role ? interview.role === filter.role : true;
        const matchesTech = filter.tech ? interview.techstack.some((tech)=>tech.toLowerCase().includes(filter.tech.toLowerCase())) : true;
        return matchesType && matchesRole && matchesTech;
    });
    // Unique options for dropdowns
    const allTypes = Array.from(new Set(interviews.map((i)=>i.type)));
    const allRoles = Array.from(new Set(interviews.map((i)=>i.role)));
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                        ...
                        children: [
                            ...
                            allTypes.map((type)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                    value: type,
                                    children: type
                                }, type, false, {
                                    fileName: "[project]/app/(root)/allinterviews/page.tsx",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                        ...
                        children: [
                            ...
                            allRoles.map((role)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                    value: role,
                                    children: role
                                }, role, false, {
                                    fileName: "[project]/app/(root)/allinterviews/page.tsx",
...
_s(AllInterviewsPage, "9KeUtzHgGTZ3MAljuwWaDCsWrac=");
_c = AllInterviewsPage;
var _c;
__turbopack_context__.k.register(_c, "AllInterviewsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_b04dcfc3._.js.map